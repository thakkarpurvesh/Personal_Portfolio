          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;Purvesh Thakkar</strong>
                <br />A passionate programmer, born and brought up in India. I am a React JS Developer.
                <br />
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a href="https://drive.google.com/file/d/1ONTGX9lsvRwtZqT_Z7vVMbwzl-nnOsVJ/view?usp=sharing" target="_blank" rel="noopener noreferrer">
